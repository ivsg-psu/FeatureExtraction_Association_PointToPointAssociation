% script_test_fcn_Patch_determineAABB.m
% This is a script to exercise the function:
% fcn_Patch_determineAABB.m
...
%     -- wrote the code
%     2022_07_19
%     -- added test case with AABB overlap and organised script into
%     sections
...
%% Example 2
% Two test patches with overlap only for AABB
% Create an empty figure ready for spatial plotting
figure(2)
clf         % Clear the figure for a new run of this script
axis equal  % Set the axes to be equal spacing for spatial plotting
...
testPatches(2).color = [0.6 0.6 0.6];
testPatches(2).primitive = 'irregular';
testPatches(2).pointsX = [69.7580645161290; 86.3479262672811; 83.1221198156682; 79.6658986175115; 72.5230414746544; 69.2972350230415] - 3;
testPatches(2).pointsY = [8.83211678832116; 20.2189781021898; 28.1021897810219; 24.8905109489051; 21.3868613138686; 17.8832116788321] + 40;

testPatches = fcn_Patch_determineAABB(testPatches); % Determine the axis-aligned bounding boxes
[testPatches,hbb] = fcn_Patch_determineAABB(testPatches,2); % Determine and plot the axis-aligned bounding boxes

[h,hpts] = fcn_Patch_plotPatch(testPatches,2);    % Plot the patches with the definition points

%% Example 3
% Two test patches with overlap only for AABB and patches
% Create an empty figure ready for spatial plotting
figure(3)
clf         % Clear the figure for a new run of this script
axis equal  % Set the axes to be equal spacing for spatial plotting
...
testPatches(2).primitive = 'irregular';
testPatches(2).pointsX = [69.7580645161290; 86.3479262672811; 83.1221198156682; 79.6658986175115; 72.5230414746544; 69.2972350230415] - 3;
testPatches(2).pointsY = [8.83211678832116; 20.2189781021898; 28.1021897810219; 24.8905109489051; 21.3868613138686; 17.8832116788321] + 60;

testPatches = fcn_Patch_determineAABB(testPatches); % Determine the axis-aligned bounding boxes
[testPatches,hbb] = fcn_Patch_determineAABB(testPatches,3); % Determine and plot the axis-aligned bounding boxes

[h,hpts] = fcn_Patch_plotPatch(testPatches,3);    % Plot the patches with the definition points
